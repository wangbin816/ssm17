	...
	<div class="panel-body">
        ...
        <div class="row">
			...
			<div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">学生姓名 </span>
					<input type="text" name="begin" placeholder="开始时间" id="beginid" class="laydate-icon  form-control layer-date">
					<input type="text" name="end" placeholder="结束时间" id="endid" class="laydate-icon  form-control layer-date">
				</div>
			</div>
				...
				<div class="modal-body">
					<form id="form_user" method="post" action="reserveStudent.htm">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							...
							<tr>
								<td>所选课程：</td>
								<td><select class="form-control" name="course_id" id = "course_id" aria-required="true" required>
